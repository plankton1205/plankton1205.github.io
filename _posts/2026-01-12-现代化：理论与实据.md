---
title: 现代化：理论与实据
description: 读 Adam Przeworski 和 Fernando Limongi 的经典论文 “Modernization theories and facts” 所做笔记与摘录。
author: plankton1205
...
> The endogenous explanation is a “modernization” theory.
{: .prompt-tip }
...
- 但是，同样是从数据中，本文的两位作者发现，民主转型的概率只在人均GDP小于$6000的范围里是随着经济发展而增加的（以人均GDP的高低来衡量发展水平的高低）。对于人均GDP超越$6000美刀的独裁国家而言，经济越是发达反而政权越是稳固。
...
- 不过我自己琢磨下表里的数据（原文里的 Table 1）注意到一个原文没有着重展开的小细节，按照人均GDP来分类的话，转型概率处于中位数以上的收入段整整齐齐集中在$4000-7000区间内，经济低于此区间的转型概率暴跌，高于此区间的转型概率也跌.下降幅度分别为 (0.0492-0.0161)/0.0492=**67.3%** 和 (0.0625-0.0333)/0.0625=**46.7%**。
